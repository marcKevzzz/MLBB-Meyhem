...
export const COACH_PERKS = [
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    description:
      "The aura of world champions flows through your squad, granting +5% win chance in the Semis and +7% in the Grand Finals.",
  ...
  },
  {
    ...
    description:
      "Your coaching staff completely decodes the opposing star playmaker, neutralizing their impact for a +5.5% series win edge.",
  ...
  },
  {
    ...
    description:
      "Unlocks god-tier smite timing at the Lord pit. Grants +7% win chance in decider games or whenever trailing in a series.",
  ...
  },
  {
    ...
    description:
      "If either your Jungler or Gold Laner has 85+ OVR, your team coordinates entirely around their lead for a +5% teamfight bonus.",
  ...
  },
  {
    ...
    description:
      "Once during the Semis or Grand Finals, rewinds a match defeat, negating the loss and granting an immediate second chance.",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    description:
      "Negates your team's first game defeat in the playoffs, providing one essential tournament safety net.",
  ...
  },
  {
    ...
    description:
      "When facing elimination in Game 5, your carries tap into maximum clutch mechanics (+5% win chance).",
  ...
  },
  {
    ...
    description:
      "When trailing behind in a BO5 series (0-1 or 1-2), your team rallies with +5% comeback odds.",
  ...
  },
  {
    ...
    description:
      "Improves late-game Lord pit smite timing, granting a +4% win chance in close matches.",
  ...
  },
  {
    ...
    description:
      "Your Roamer and Mid coordinate an explosive level 1 buff steal, delaying the enemy spike for a +4% early game edge.",
  ...
  },
  {
    ...
    description:
      "Your EXP Laner applies endless sidelane pressure, forcing messy enemy rotations for a +4% macro advantage.",
  ...
  },
  {
    ...
    description:
      "Intense reaction-time conditioning grants your core playmakers a +4% boost in high-intensity 5v5 teamfights.",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    description:
      "Identifies flaws in the opponent’s draft, granting your team a +3% macro advantage.",
  ...
  },
  {
    ...
    description:
      "Prioritizes early neutral objectives, giving +3% win probability across all games.",
  ...
  },
  {
    ...
    description:
      "Your Roamer directs rotations cleanly, giving +3% teamfight coordination.",
  ...
  },
  {
    ...
    description:
      "The roaring arena crowd energizes your roster, giving +4% momentum in Games 1 & 2.",
  ...
  },
  {
    ...
    description:
      "Allocates extra jungle waves to the Gold Laner, adding +3% win chance in late-game teamfights.",
  ...
  },
  {
    ...
    description:
      "Catches the enemy by surprise with an unexpected hero pick (+3.5% series win rate).",
  ...
  },
  {
    ...
    description:
      "Baiting face-checks in crucial objective bushes yields devastating pickoffs (+3.5% pickoff victory odds).",
  ...
  },
  {
    ...
    description:
      "Your EXP Laner pins down the opposing offlaner, giving your Jungler complete invasion freedom (+3% odds).",
  ...
  },
  {
    ...
    description:
      "Disciplined early neutral monster control provides a steady +3% gold scaling edge.",
  ...
  },
  {
    ...
    description:
      "Rapid mid-lane wave clearance opens up lightning fast side-ganks (+3% rotation odds).",
  ...
  },
  {
    ...
    description:
      "Patients under tower stalls aggressive opponent dives, yielding +3.5% defensive composure.",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    description:
      "Sharpened micro-mechanics add a subtle +2% boost to individual lane clashes.",
  ...
  },
  {
    ...
    description:
      "Improves early vision control in the river, granting +2.5% early-game odds.",
  ...
  },
  {
    ...
    description:
      "Maintains player focus through long marathons, granting +3% in Games 4 & 5.",
  ...
  },
  {
    ...
    description:
      "Players execute with +2% higher confidence when on their primary signature hero.",
  ...
  },
  {
    ...
    description:
      "Your EXP Laner manages waves patiently, reducing the enemy team’s early tower push (+2% odds).",
  ...
  },
  {
    ...
    description:
      "Prevents tilt after a lost game, stabilizing series performance (+2.5% bounceback).",
  ...
  },
  {
    ...
    description:
      "Quick tactical whiteboard review between games grants a steady +2% consistency boost.",
  ...
  },
  {
    ...
    description:
      "Studying enemy rotation habits awards a clean +2% positioning advantage.",
  ...
  },
  {
    ...
    description:
      "Warm hands maintain lightning-fast response times, granting +2% skillshot consistency.",
  ...
  },
  {
    ...
    description:
      "Fast lane-clearing enables quicker roams across river choke points (+2% odds).",
  ...
  },
  {
    ...
    description:
      "A crisp level 1 leash saves Retribution for contested river objectives (+2% odds).",
  ...
  },
  {
    ...
    description:
      "Clear shotcaller pinging collapses all damage onto isolated carries (+2% teamfight odds).",
  ...
  },
  {
    ...
    description:
      "Smart defensive item adjustments mitigate early opponent burst (+2% mitigation odds).",
  ...
  },
  {
    ...
    description:
      "Tracking exact neutral respawn timers sets up flawless ambush traps (+2% odds).",
  ...
  },
  {
    ...
    description:
      "A motivational huddle resets mental fatigue and refuels team energy (+2% odds).",
 ...
 * Balanced rarity weights (Common: 1.8, Rare: 1.8, Epic: 1.3, Legendary: 0.5)
 * ensuring Commons don't crowd out the deck while Epics (~35%) and Legendaries (~12.5%) have healthy drop chances!
 */
export function getPerkChoices(existingPerkIds = []) {
  ...
  const pool = [];
  available.forEach((p) => {
    let weight = 2.5; // Common: 1.8 (reduced so Commons don't crowd)
    if (p.rarity === "rare") weight = 2; // Rare: 1.8
    if (p.rarity === "epic") weight = 1.3; // Epic: 1.3 (solid ~35% appearance per roll)
    if (p.rarity === "legendary") weight = 0.5; // Legendary: 0.5 (exciting ~12.5% appearance per roll)
